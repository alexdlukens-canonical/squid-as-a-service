# Resource Schema: terrasquid_source_group

**Type**: Resource

**API Endpoints**: `POST /source-groups/`, `GET /source-groups/{id}/`, `PUT /source-groups/{id}/`, `DELETE /source-groups/{id}/`
...
| sources | list of string (UUID) | yes | no | List of SourceACL resource IDs |
...
|-----------|-------------|------|--------------|-------------|
| Create | POST | /source-groups/ | 201 (new), 200 (existing) | 400, 422 |
| Read | GET | /source-groups/{id}/ | 200 | 404 |
| Update | PUT | /source-groups/{id}/ | 200 | 400, 404, 422 |
| Delete | DELETE | /source-groups/{id}/ | 204 | 404 |

## Import

Accepts the resource UUID: `terraform import terrasquid_source_group.example <uuid>`
