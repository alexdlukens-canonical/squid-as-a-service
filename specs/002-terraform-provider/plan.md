...
**Branch**: `002-terraform-provider` | **Date**: 2026-05-13 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `/specs/002-terraform-provider/spec.md`
