...
**Input**: Design documents from `/specs/003-terraform-provider/`
...
- [x] T001 Create Go module and project structure per plan.md in terraform/
- [x] T002 Initialize go.mod with terraform-plugin-framework, terraform-plugin-testing, and terraform-plugin-go dependencies in terraform/go.mod
- [x] T003 [P] Configure GNUmakefile with build, test, and testacc targets in terraform/GNUmakefile
- [x] T004 [P] Configure .golangci.yml linting rules in terraform/.golangci.yml
- [x] T005 Create main.go provider server entrypoint with providerserver.Serve in terraform/main.go
...
- [x] T006 Create API client struct and constructor in terraform/internal/client/client.go
- [x] T007 Create API error type with status code, message, and field_errors mapping in terraform/internal/client/errors.go
- [x] T008 [P] Create BaseResource model with id, service, name, key_prefix, created_at, updated_at in terraform/internal/model/base_resource.go
- [x] T009 [P] Create Status model with db_config_version, applied_config_version, last_reload, last_reload_ok, unit in terraform/internal/model/status.go
- [x] T010 [P] Create SourceACL model extending BaseResource with cidr list in terraform/internal/model/source_acl.go
- [x] T011 [P] Create SourceGroup model extending BaseResource with sources UUID list in terraform/internal/model/source_group.go
- [x] T012 [P] Create DestinationConfig model extending BaseResource with dst, type, ports, port_groups in terraform/internal/model/destination_config.go
- [x] T013 [P] Create DestinationGroup model extending BaseResource with destinations UUID list in terraform/internal/model/destination_group.go
- [x] T014 [P] Create PortGroup model extending BaseResource with ports list in terraform/internal/model/port_group.go
- [x] T015 [P] Create ACLRule model extending BaseResource with priority, src, src_group, dst, dst_group in terraform/internal/model/acl_rule.go
- [x] T016 Implement provider.go with Schema (endpoint, api_key attributes), Configure method with env var fallback, Resources and DataSources lists in terraform/internal/provider/provider.go
- [x] T017 Implement API client HTTP helper methods (doRequest, handleAuth, parseError) in terraform/internal/client/client.go
...
- [x] T018 [US7] Write acceptance test for terrasquid_status data source in terraform/internal/provider/status_data_source_test.go
- [x] T019 [US7] Write unit test for API client GET /status/ in terraform/internal/client/status_test.go
- [x] T020 [US7] Write acceptance test for provider configuration with invalid API key (expect auth error) in terraform/internal/provider/provider_test.go

### Implementation for User Story 7

- [x] T021 [US7] Implement GET /status/ client method in terraform/internal/client/status.go
- [x] T022 [US7] Implement terrasquid_status data source (Read method, Schema with computed attributes) in terraform/internal/provider/status_data_source.go
- [x] T023 [US7] Register status data source in provider.go DataSources() in terraform/internal/provider/provider.go
- [x] T024 [US7] Add provider configuration validation (missing endpoint/api_key diagnostics) in terraform/internal/provider/provider.go
...
- [x] T025 [US1] Write acceptance test for terrasquid_source_acl CRUD (create, read, update, delete) in terraform/internal/provider/source_acl_resource_test.go
- [x] T026 [US1] Write acceptance test for terrasquid_source_acl import in terraform/internal/provider/source_acl_resource_test.go
- [x] T027 [US1] Write acceptance test for idempotent creation (HTTP 200 de-dup) in terraform/internal/provider/source_acl_resource_test.go
- [x] T028 [P] [US1] Write unit tests for API client source ACL methods in terraform/internal/client/source_acl_test.go

### Implementation for User Story 1

- [x] T029 [P] [US1] Implement API client methods (Create, Read, Update, Delete) for source ACLs in terraform/internal/client/source_acl.go
- [x] T030 [US1] Implement terrasquid_source_acl resource (Schema, Create, Read, Update, Delete, ImportState) in terraform/internal/provider/source_acl_resource.go
- [x] T031 [US1] Handle HTTP 200 de-duplication in Create method in terraform/internal/provider/source_acl_resource.go
- [x] T032 [US1] Register terrasquid_source_acl resource in provider.go Resources() in terraform/internal/provider/provider.go
...
- [x] T033 [US4] Write acceptance test for terrasquid_port_group CRUD in terraform/internal/provider/port_group_resource_test.go
- [x] T034 [US4] Write acceptance test for terrasquid_port_group import in terraform/internal/provider/port_group_resource_test.go
- [x] T035 [P] [US4] Write unit tests for API client port group methods in terraform/internal/client/port_group_test.go

### Implementation for User Story 4

- [x] T036 [P] [US4] Implement API client methods for port groups in terraform/internal/client/port_group.go
- [x] T037 [US4] Implement terrasquid_port_group resource (Schema, CRUD, ImportState) in terraform/internal/provider/port_group_resource.go
- [x] T038 [US4] Register terrasquid_port_group resource in provider.go Resources() in terraform/internal/provider/provider.go
...
- [x] T039 [US3] Write acceptance test for terrasquid_destination_config CRUD in terraform/internal/provider/destination_config_resource_test.go
- [x] T040 [US3] Write acceptance test for terrasquid_destination_config import in terraform/internal/provider/destination_config_resource_test.go
- [x] T041 [P] [US3] Write unit tests for API client destination config methods in terraform/internal/client/destination_config_test.go

### Implementation for User Story 3

- [x] T042 [P] [US3] Implement API client methods for destination configs in terraform/internal/client/destination_config.go
- [x] T043 [US3] Implement terrasquid_destination_config resource (Schema with ports/port_groups, CRUD, ImportState) in terraform/internal/provider/destination_config_resource.go
- [x] T044 [US3] Register terrasquid_destination_config resource in provider.go Resources() in terraform/internal/provider/provider.go
...
- [x] T045 [US2] Write acceptance test for terrasquid_source_group resource CRUD in terraform/internal/provider/source_group_resource_test.go
- [x] T046 [US2] Write acceptance test for terrasquid_source_group resource import in terraform/internal/provider/source_group_resource_test.go
- [x] T047 [US2] Write acceptance test for terrasquid_source_group data source (name lookup) in terraform/internal/provider/source_group_data_source_test.go
- [x] T048 [P] [US2] Write unit tests for API client source group methods in terraform/internal/client/source_group_test.go

### Implementation for User Story 2

- [x] T049 [P] [US2] Implement API client methods for source groups in terraform/internal/client/source_group.go
- [x] T050 [US2] Implement terrasquid_source_group resource (Schema with sources list, CRUD, ImportState) in terraform/internal/provider/source_group_resource.go
- [x] T051 [US2] Implement terrasquid_source_group data source (name query parameter lookup) in terraform/internal/provider/source_group_data_source.go
- [x] T052 [US2] Register terrasquid_source_group resource and data source in provider.go in terraform/internal/provider/provider.go
